    ...
    <header className="site-header" data-testid="site-header">
      <div className="header-inner">
        ...
        <nav className="header-nav" data-testid="header-nav">
          ...
          <button
            className={`nav-link ${activeView === "demo" || activeView === "results" ? "active" : ""}`}
            data-testid="nav-demo"
            onClick={() => setActiveView("demo")}
          >
            Analyzer
          </button>
          <a href="#features" className="nav-link" data-testid="nav-features">
            Features
          </a>
          <a href="#install" className="nav-link" data-testid="nav-install">
            Install
          </a>
        </nav>
